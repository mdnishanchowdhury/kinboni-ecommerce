            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-auto md:h-[550px]">
                ...
                <div className="md:col-span-2 flex flex-col rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                    ...
                    <div className="h-1/2 bg-[#FDE2F3] flex flex-col items-center justify-center p-6 text-center">
                        ...
                        <button className="bg-green-500 text-white px-5 py-2 rounded-full flex items-center gap-2 text-sm transition-all hover:bg-black">
                            Shop Now
                            <span className="bg-white text-[#008080] rounded-full w-4 h-4 flex items-center justify-center text-[8px] font-bold"><FaStore /></span>
                        </button>
                    </div>
                </div>
